...
def detect_plate_yolo(image_path, use_paddle_ocr=True):
    ...
    print(f"Ket qua OCR ({'PaddleOCR' if use_paddle_ocr and PADDLE_OCR_AVAILABLE else 'Tesseract'}): ", number_plate)
...
def read_number_plate_tesseract(image_or_path):
    """
    Đọc biển số xe sử dụng Tesseract OCR (phương pháp cũ)
    """
